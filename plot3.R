...
plot3 <- plot(dates, hpc2$Sub_metering_1, type="l", ylab = "Energy Sub metering")
#somehow because I had set the x axis in plot 2 I don't have to set it in plot 3 now.
lines(dates, hpc2$Sub_metering_2, type="l", col="red")
lines(dates, hpc2$Sub_metering_3, type="l", col="blue")
legend("topright", names(hpc2)[7:9], lty=1, col=c("black", "red", "blue"), cex=0.8)
